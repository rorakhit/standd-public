...
export const roster: Player[] = [
  ...
  { number: 35, name: 'Morgan Messner', position: 'GK', hometown: 'Drexel Hill, Pennsylvania', leagueSlug: 'nwsl', teamSlug: 'portland-thorns', teamName: 'Portland Thorns', countryCode: 'us', height: "5'10\"" },
  ...
  { number: 21, name: 'Jessie Fleming', position: 'MID', hometown: 'London, Canada', leagueSlug: 'nwsl', teamSlug: 'portland-thorns', teamName: 'Portland Thorns', countryCode: 'ca', height: "5'5\"" },
  ...
  { number: 23, name: 'Marie Müller', position: 'MID', hometown: 'Dortmund, Germany', leagueSlug: 'nwsl', teamSlug: 'portland-thorns', teamName: 'Portland Thorns', countryCode: 'de', height: "5'6\"" },
  { number: 26, name: 'Mimi Alidou', position: 'MID', hometown: 'Montreal, Canada', leagueSlug: 'nwsl', teamSlug: 'portland-thorns', teamName: 'Portland Thorns', countryCode: 'ca', height: "5'3\"" },
  ...
  { number: 7, name: 'Caiya Hanks', position: 'FWD', hometown: 'Kailua-Kona, Hawaii', leagueSlug: 'nwsl', teamSlug: 'portland-thorns', teamName: 'Portland Thorns', countryCode: 'us', height: "5'4\"" },
  { number: 9, name: 'Sophia Wilson', position: 'FWD', hometown: 'Windsor, Colorado', leagueSlug: 'nwsl', teamSlug: 'portland-thorns', teamName: 'Portland Thorns', countryCode: 'us', height: "5'6\"" },
  { number: 10, name: 'Deyna Castellanos', position: 'FWD', hometown: 'Maracay, Venezuela', leagueSlug: 'nwsl', teamSlug: 'portland-thorns', teamName: 'Portland Thorns', countryCode: 've', height: "5'7\"" },
  { number: 11, name: 'Maddie Padelski', position: 'FWD', hometown: 'Nolensville, Tennessee', leagueSlug: 'nwsl', teamSlug: 'portland-thorns', teamName: 'Portland Thorns', countryCode: 'us', height: "5'0\"" },
