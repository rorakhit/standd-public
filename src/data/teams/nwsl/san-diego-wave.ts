...
export const roster: Player[] = [
  ...
  { number: 11, name: 'Gia Corley', position: 'MID', hometown: 'Tacoma, Washington', leagueSlug: 'nwsl', teamSlug: 'san-diego-wave', teamName: 'San Diego Wave', countryCode: 'us', height: "5'3\"" },
  ...
  { number: 88, name: 'Maria Eduarda Rodrigues Silva', position: 'FWD', hometown: 'São Paulo, Brazil', leagueSlug: 'nwsl', teamSlug: 'san-diego-wave', teamName: 'San Diego Wave', countryCode: 'br', height: "5'2\"" },
];
